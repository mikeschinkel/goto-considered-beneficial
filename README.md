...
2. Similarly, if you find someone else having using numerous `gotos` it is an _obvious indicator_ the function should be refactored into two or more functions.
...
- [Goto and the folly of dogma](https://manybutfinite.com/post/goto-and-the-folly-of-dogma/) — _"This is exactly how dogma hurts software development. We take a sensible rule that works most of the time and promote it to sacred edict, deeming violators as inferior programmers, producers of unclean code."_
## Footnotes
